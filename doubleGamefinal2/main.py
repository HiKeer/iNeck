            ...
            for rect in face_rects:
                if ret:#rect.width() < width and rect.height() < height:  # 检查人脸框的大小是否合理
                    ...
                    if face_x < middle_line_x:
                        ...
                        # 键盘操作逻辑
                        if (euler_angle[1, 0] < -15 or euler_angle[2, 0] > 20) and counter1 >= 13:  # 左转超过25度
                        ...
                        if (euler_angle[1, 0] > 15 or euler_angle[2, 0] < -20) and counter3 >= 13:  # 右转超过25度
                        ...
                        if euler_angle[0, 0] > 5 and counter4 >= 13:  # 低头超过15度
                        ...
                        # 键盘操作逻辑
                        if (euler_angle[1, 0] < -15 or euler_angle[2, 0] > 20) and counter5 >= 13:  # 左转超过25度
                            keyboard.press('a')
                            keyboard.release('a')
                            counter5 = 0
                        else:
                        ...
                        if (euler_angle[1, 0] > 15 or euler_angle[2, 0] < -20) and counter6 >= 13:  # 右转超过25度
                            keyboard.press('d')
                            keyboard.release('d')
                            counter6 = 0
                        else:
                        ...
                        if euler_angle[0, 0] > 5 and counter8 >= 13:  # 低头超过15度
                            keyboard.press('s')
                            keyboard.release('s')
                            counter8 = 0
                        else:
